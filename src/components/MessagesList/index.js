        ...
        return (
          <React.Fragment key={message.id}>
            ...
            >
              ...
              {(message.mediaUrl || message.mediaType === "locationMessage" || message.mediaType === "contactMessage" || message.mediaType === "template" || message.mediaType === "pollCreationMessageV3" || message.mediaType === "eventMessage" || message.mediaType === "listMessage" || message.mediaType === "viewOnceMessage" || message.mediaType === "interactiveMessage" || message.mediaType === "adMetaPreview" // Adicionado para aceitar o componente de preview de anúncio 
              ...
              <div className={clsx(classes.textContentItem, {
                ...
                {message.quotedMsg && renderQuotedMessage(message)}
                {
                  (
                    ...
                    message.mediaType !== "template" && message.mediaType != "pollCreationMessageV3" && message.mediaType != "eventMessage" &&
        ...
        return (
          <React.Fragment key={message.id}>
            ...
            >
              ...
              {(message.mediaUrl || message.mediaType === "locationMessage" || message.mediaType === "contactMessage" || message.mediaType === "template" || message.mediaType === "pollCreationMessageV3" || message.mediaType === "eventMessage" || message.mediaType === "viewOnceMessage" || message.mediaType === "listMessage" || message.mediaType === "interactiveMessage" || message.mediaType === "adMetaPreview" // Adicionado para aceitar o componente de preview de anúncio
                //|| message.mediaType === "multi_vcard" 
              ) && checkMessageMedia(message)}
              <div
              ...
              >
...

                {
                  ...
                  (message.mediaType !== "audio" && message.mediaType != "reactionMessage" && message.mediaType != "locationMessage" && message.mediaType !== "contactMessage" && message.mediaType != "pollCreationMessageV3" && message.mediaType != "eventMessage" && message.mediaType != "viewOnceMessage" && message.mediaType != "interactiveMessage" && message.mediaType != "listMessage" && message.mediaType !== "template" && message.mediaType !== "adMetaPreview") && (
                    <>
                      {xmlRegex.test(message.body) && (
