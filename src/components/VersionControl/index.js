   ...
   <div>
      <Button
       variant="contained"
        ...
        >
          {returnDays(user?.company?.dueDate) === 0 ? `Sua licença vence hoje! Clique aqui para verificar atualizações.` : `Sua licença vence em ${returnDays(user?.company?.dueDate)} dias!  Clique aqui para verificar atualizações.`}
        </Button>
